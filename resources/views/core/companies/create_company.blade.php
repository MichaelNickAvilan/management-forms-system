    ...
    <div class="row">
        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <h2>Registra una compañía</h2>
                    <p>Una compañía se define como el nivel superior de categorización de uno o varios sistemas.</p>
                    @if ($errors->any())
                    ...
                    <form method="POST" action="{{ route('companies.store') }}" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user" name="name_company" placeholder="{{ __('Digite el nombre de la compañía') }}" value="{{ old('name') }}" required autofocus>
                            </div>
                            <div class="form-group">
                                <label class="form-control-label" for="company_logo">Logo de la compañía<span class="small text-danger">*</span></label>
                                <input type="file" class="form-control form-control-user" name="company_logo" required autofocus/>
                            </div>
                            <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-user btn-block">
                            <i class="fas fa-save"></i> {{ __('Registrar compañía') }}
                            </button>
                        </div>
                    </form>
                </div>
