                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">{{ __('Registrate como un nuevo usuario') }}</h1>
                                </div>
                                ...
                                <form method="POST" action="{{ route('register') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user" name="password" placeholder="{{ __('Clave') }}" required>
                                    </div>

                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user" name="password_confirmation" placeholder="{{ __('Confirmar Clave') }}" required>
                                    </div>
                                ...
                                <div class="text-center">
                                    <a class="small" href="{{ route('login') }}">
                                        {{ __('¿Tienes una cuenta? Autentícate!') }}
                                    </a>
                                </div>
                            </div>
                        </div>
